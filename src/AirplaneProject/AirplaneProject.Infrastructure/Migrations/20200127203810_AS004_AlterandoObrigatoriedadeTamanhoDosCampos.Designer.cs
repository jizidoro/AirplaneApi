...
namespace AirplaneProject.Infrastructure.Migrations
{
    ...
    [Migration("20200127203810_AS004_AlterandoObrigatoriedadeTamanhoDosCampos")]
    partial class AS004_AlterandoObrigatoriedadeTamanhoDosCampos
    {
            ...
            modelBuilder.Entity("Automacao.Domain.Models.MaterialEstocado", b =>
                {
                    ...
                    b.Property<string>("Reabastecimento")
                        .IsRequired()
                        .HasMaxLength(50);
            ...
            modelBuilder.Entity("Automacao.Domain.Models.SituacaoMaterial", b =>
                {
                    ...
                    b.HasIndex("Codigo")
                        .HasName("IX_Situacao_Materiais_Codigo");
