...
namespace AirplaneProject.Infrastructure.Migrations
{
    ...
    [Migration("20200226194015_AS004_AddNomeMaterialFornecido")]
    partial class AS004_AddNomeMaterialFornecido
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Automacao.Domain.Models.Almoxarifado", b =>
                {
                    ...
                    b.Property<string>("CodigoAreaMrp")
                        .IsRequired()
                        .HasMaxLength(50);

                    b.Property<string>("CodigoCentroMrp")
                        .IsRequired()
                        .HasMaxLength(50);
            ...
            modelBuilder.Entity("Automacao.Domain.Models.Mrp", b =>
                {
                    ...
                    b.Property<int?>("MrpRegraEstoqueId");
                    ...
                    b.HasIndex("MrpRegraEstoqueId");

                    b.ToTable("Mrps");
                });

            modelBuilder.Entity("Automacao.Domain.Models.MrpRegraEstoque", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<int>("SituacaoRegraEstoque")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Automacao.Domain.Models.Views.AlmoxarifadoView", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<string>("AlmoxarifadoCodigo")
                        .IsRequired()
                        .HasMaxLength(50);

                    b.Property<string>("AlmoxarifadoNome")
                        .IsRequired()
                        .HasMaxLength(50);
            ...
            modelBuilder.Entity("Automacao.Domain.Models.Views.MaterialEstocadoView", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<string>("CategoriaMaterialCodigo")
                        .IsRequired()
                        .HasMaxLength(50);

                    b.Property<int>("CategoriaMaterialId");

                    b.Property<string>("CategoriaMaterialNome")
                        .IsRequired()
                        .HasMaxLength(50);

                    b.Property<string>("ClasseMaterialCodigo")
                        .IsRequired()
                        .HasMaxLength(50);

                    b.Property<int>("ClasseMaterialId");

                    b.Property<string>("ClasseMaterialNome")
                        .IsRequired()
                        .HasMaxLength(50);
                    ...
                    b.Property<string>("MaterialEstocadoCodigo");

                    b.Property<string>("MaterialEstocadoNome");

                    b.Property<string>("MaterialFornecidoCodigo")
                        .IsRequired()
                        .HasMaxLength(120);

                    b.Property<int>("MaterialFornecidoId");

                    b.Property<string>("MaterialFornecidoNome")
                        .IsRequired()
                        .HasMaxLength(120);

                    b.Property<string>("MaterialFornecidoPartNumber")
                        .IsRequired()
                        .HasMaxLength(50);

                    b.Property<string>("MrpCodigo")
                        .IsRequired()
                        .HasMaxLength(50);

                    b.Property<int>("MrpId");

                    b.Property<string>("MrpNome")
                        .IsRequired()
                        .HasMaxLength(50);

                    b.Property<string>("SituacaoMaterialCodigo")
                        .IsRequired()
                        .HasMaxLength(50);

                    b.Property<int>("SituacaoMaterialId");

                    b.Property<string>("SituacaoMaterialNome")
                        .IsRequired()
                        .HasMaxLength(50);

                    b.HasKey("Id");

                    b.ToTable("vwMaterialEstocado");
                });

            modelBuilder.Entity("Automacao.Domain.Models.Views.SobressalenteView", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<string>("MaterialFornecidoNM")
                        .IsRequired()
                        .HasMaxLength(120);
            ...
            modelBuilder.Entity("Automacao.Domain.Models.Mrp", b =>
                {
                    b.HasOne("Automacao.Domain.Models.MrpRegraEstoque")
                        .WithMany("Mrps")
                        .HasForeignKey("MrpRegraEstoqueId");
                });

            modelBuilder.Entity("Automacao.Domain.Models.MrpRegraEstoque", b =>
                {
                    b.HasOne("Automacao.Domain.Models.Mrp", "Mrp")
                        .WithMany("MrpRegraEstoques")
                        .HasForeignKey("MrpId")
                        .OnDelete(DeleteBehavior.Restrict);
                });
