...
namespace AirplaneProject.Infrastructure.Migrations
{
    ...
    [Migration("20191217202324_AS003_AddIndiceModuloAlteracao")]
    partial class AS003_AddIndiceModuloAlteracao
    {
            ...
            modelBuilder.Entity("Automacao.Domain.Models.HistoricoAlteracao", b =>
                {
                    ...
                    b.HasOne("Automacao.Domain.Models.Alteracao")
                        .WithMany("HistoricoAlteracoes")
                        .HasForeignKey("AlteracaoId1");
