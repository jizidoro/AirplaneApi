...
{
	public class IniciadorConfiguration : IEntityTypeConfiguration<Iniciador>
	{
		public void Configure(EntityTypeBuilder<Iniciador> builder)
		{
			...
			builder.HasIndex(c => c.Codigo).HasName("IX_Iniciadores_Codigo");
